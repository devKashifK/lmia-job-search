...
export function ClientDetailView({ tab }: ClientDetailViewProps) {
    ...
    return (
        <div className="p-4 w-full max-w-[1400px] mx-auto space-y-4">
            ...
            {/* PERSISTENT STRATEGIC COMMAND */}
            <StrategicCommand client={client} />
            ...
            <Tabs defaultValue="profile" className="w-full">
                ...
                <TabsContent value="coaching" className="m-0 focus-visible:outline-none">
                    <ClientCoaching client={client} />
                </TabsContent>
