  ...
  return (
    <div className="p-4 space-y-4 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          <h1 className="text-lg font-bold text-gray-900 tracking-tight">Clients Management</h1>
          <p className="text-[11px] text-gray-500">Manage and track your client cases for Canadian job search.</p>
        </div>
