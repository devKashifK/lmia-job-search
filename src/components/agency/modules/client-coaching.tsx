...
export function ClientCoaching({ client }: ClientCoachingProps) {
    ...
    return (
        <div className="space-y-4 pb-12">
            {/* Compact Stats Bar */}
            <Card className="p-3 border-gray-100 shadow-sm bg-white rounded-xl">
                <div className="flex flex-wrap items-center justify-between gap-6 px-2">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest leading-none mb-1">Portal Views</p>
                            <h3 className="text-xs font-bold text-gray-900 tracking-tight">{viewsCount} Sessions</h3>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <h3 className="text-xs font-bold text-gray-900 tracking-tight uppercase">{client.status || 'Active'}</h3>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest leading-none mb-1">Last Update</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
                <Card className="lg:col-span-8 p-5 border-gray-100 shadow-xl bg-white rounded-xl relative">
                    <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-3">
                            <div className="p-2 bg-brand-600 rounded-xl text-white shadow-md shadow-brand-500/10">
                                <MessageSquareQuote className="w-4 h-4" />
                            </div>
                            <h3 className="text-sm font-bold text-gray-900 tracking-tight uppercase">Advisor Coaching Hub</h3>
                        </div>
                        <Button
                            onClick={handleSave}
                            disabled={isUpdating}
                            size="sm"
                            className="bg-brand-600 hover:bg-brand-700 text-white rounded-xl h-8 px-4 font-bold text-[10px] uppercase tracking-wider gap-2"
                        >
                    ...
                    <div className="space-y-3">
                        <div className="relative">
                            ...
                            />
                            <div className="absolute bottom-3 right-3 text-[9px] font-bold text-gray-300 pointer-events-none uppercase tracking-tighter">
                                Visible to Client
                            </div>
                        </div>

                        <div className="flex items-center gap-2 p-2 bg-brand-50/50 rounded-xl border border-brand-100/30 text-brand-700">
                ...
                <div className="lg:col-span-4 space-y-4">
                    <Card className="p-5 border-gray-100 shadow-sm bg-white rounded-xl space-y-4">
                        <div className="flex items-center justify-between">
                            ...
                            <Badge variant="outline" className="text-[9px] font-bold border-emerald-100 text-emerald-600 bg-emerald-50 rounded-xl">PRIVATE LINK</Badge>
                        </div>

                        <div className="p-3 bg-gray-50 rounded-xl border border-gray-100 space-y-2">
                            <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest">Access URL</p>
                            <div className="flex items-center justify-between gap-1.5 bg-white p-1 rounded-xl border border-gray-100">
                                ...
                                <Button
                                    variant="ghost"
                                    size="icon"
                                    className="h-7 w-7 rounded-xl hover:bg-brand-50 hover:text-brand-600 shrink-0"
                                    onClick={() => {
                    ...
                    <Card className="p-4 border-gray-100 bg-slate-900 rounded-xl">
                        <div className="flex items-center gap-2 mb-2">
                            <Target className="w-3.5 h-3.5 text-brand-400" />
                            <span className="text-[9px] font-bold text-white uppercase tracking-widest">Quick Actions</span>
                        </div>
                        <div className="space-y-1.5">
                            <Button variant="outline" size="sm" className="w-full justify-start text-[10px] font-bold h-8 border-slate-700 text-slate-300 hover:bg-slate-800 hover:text-white rounded-xl">
