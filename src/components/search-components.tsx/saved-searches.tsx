    ...
    return (
      <>
        ...
        <div className="flex flex-col items-center justify-center h-[300px] px-6 text-center">
          <div className="p-3 bg-gradient-to-b from-orange-50 to-orange-100/50 rounded-xl mb-3">
          ...
          {searches.map((search) => (
            <div key={search.id} className="group relative">
              <CustomLink
                ...
                className="block"
              >
                <div className="flex items-center gap-3 px-4 py-2.5 rounded-lg hover:bg-orange-50/60 transition-all group-hover:pr-12">
                  <div className="shrink-0 w-8 h-8 flex items-center justify-center rounded-lg bg-orange-100/70 text-orange-600 group-hover:bg-white group-hover:shadow-sm transition-all">
                            ...
                            <div className="flex items-center gap-1.5">
                              {Object.entries(search.filters)
                                ...
                                .map(([key, value]) => (
                                  <span
                                    key={key}
                                    className="px-1.5 py-0.5 text-[10px] font-medium bg-white text-zinc-500 rounded-md border group-hover:border-orange-200/70 transition-colors"
                                  >
                                    {key}: {value}
                                  </span>
                                ))}
