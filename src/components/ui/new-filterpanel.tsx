    ...
    <div className="w-full lg:w-48 bg-white lg:border-r lg:border-gray-200 h-full flex flex-col">
      ...
      <div className="px-2 py-2 border-b border-gray-100">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-xs font-bold text-gray-900 uppercase tracking-wide">Filters</h2>
        </div>
      </div>
                ...
                <div key={column.accessorKey}>
                  ...
                  >
                    <div className="flex items-center gap-1.5">
                      <div
                        className={`p-0.5 rounded transition-colors ${activeFilters > 0
                    ...
                    <ChevronDown
                      className={`w-3 h-3 text-gray-400 transition-transform duration-200 ${isCollapsed ? 'rotate-0' : 'rotate-180'
                        }`}
                    />
                  </button>
