    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[650px] rounded-[24px] overflow-hidden border-none shadow-2xl p-0 bg-white/90 backdrop-blur-xl">
        <div className="relative">
          ...
          <div className={`px-6 py-5 relative overflow-hidden transition-colors duration-500 ${
            isSuccess ? 'bg-brand-100/80 shadow-inner shadow-brand-200/20' : 'bg-brand-50/80'
          }`}>
                      ...
                      <div className={`p-4 rounded-2xl border transition-all duration-300 ${
                        ...
                        <div className="flex items-start gap-3">
                          <div className={`p-2.5 rounded-xl ${
                            preferencesMatched ? 'bg-white text-brand-600 shadow-sm' : 'bg-white text-brand-500 shadow-sm'
                          }`}>
                  ...
                  <div className="p-5 bg-brand-50/50 rounded-2xl border border-brand-100/50 space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <p className="text-[10px] text-gray-500 leading-relaxed font-semibold px-1">
                        ...
                        To apply manually, <span className="text-brand-600 font-black border-b border-brand-200 cursor-pointer">unlock employer info</span>.
                      </p>
                    </div>
                  </div>
          ...
          <DialogFooter className="px-6 pb-6 pt-0">
            {step < 3 ? (
              <Button
                ...
                className={`relative w-full font-black h-14 rounded-2xl transition-all overflow-hidden uppercase tracking-[0.2em] text-[10px] border-none group ${
                  step === 1 
