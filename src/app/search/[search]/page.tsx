          ...
          <nav className="flex items-center justify-between px-4 py-0 shadow-sm">
            <div className="flex space-x-4">
              <div className="flex items-center gap-2 font-semibold py-2">
                <div className="h-6 w-6 rounded bg-active text-red-600 flex items-center justify-center text-sm">
                  L
                </div>
                LIMA
              </div>
              <div className="flex  space-x-1   py-0">
                <Link
                  href="#"
                  className="flex items-center px-3 py-2 text-sm hover:bg-active hover:text-red-600"
                >
                ...
                <Link
                  href="#"
                  className={cn(
                    "flex items-center px-3 py-2 text-sm hover:bg-active hover:text-red-600",
                    active === "search" &&
                      "bg-active text-red-600 shadow-[inset_0_1px_1px_rgba(0,0,0,0.2)]"
                  )}
                >
            ...
            <div className="flex items-center space-x-4">
              <button className="p-1 hover:bg-red-400 text-black/50 hover:text-white rounded-full">
              ...
              <button className=" hover:bg-red-400 text-active hover:text-white rounded-full">
