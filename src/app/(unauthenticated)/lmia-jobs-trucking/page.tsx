      ...
      <main className="flex-1">
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-[52px] font-black text-white leading-[1.1] tracking-tight mb-6">
                LMIA Jobs in <span className="text-[#F5A623]">Trucking & Transportation</span>
              </h1>
              ...
              <div className="flex flex-wrap items-center gap-4">
                 <Link 
                  ...
                  className="bg-[#F5A623] hover:bg-[#F5A623]/90 text-[#0D1B3E] font-bold px-8 py-4 rounded-full transition-all inline-flex items-center gap-2 hover:-translate-y-0.5 shadow-xl shadow-[#F5A623]/20"
                >
              ...
              <div className="bg-white/[0.03] backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-2xl">
                ...
                <div className="mt-4 bg-[#F5A623]/10 border border-[#F5A623]/30 border-dashed rounded-xl p-4 text-center">
                  <p className="text-sm text-[#F5A623]">
                    🔒 <Link href="/sign-up" className="font-bold underline hover:text-[#F5A623]/80">Sign up free</Link> to see 1,400+ trucking listings.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-20 px-6 bg-white border-b border-gray-100">
          <div className="max-w-5xl mx-auto">
            <div className="text-center max-w-2xl mx-auto mb-16">
              <div className="text-xs font-bold text-[#F5A623] uppercase tracking-widest mb-3">In-Demand Occupations</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-20">
              {[
                { title: 'Truck Driver (Long Haul)', noc: '73300', demand: 'Very High', color: 'text-[#0F7B5E]' },
                { title: 'Dispatcher', noc: '13200', demand: 'High', color: 'text-[#1D6FBF]' },
                { title: 'Company Manager', noc: '70010', demand: 'Medium', color: 'text-[#C47B12]' },
              ].map((occ, i) => (
                <div key={i} className="bg-white border border-gray-200 rounded-xl p-5 hover:border-[#1D6FBF]/30 transition-all">
                  <div className="text-sm font-bold text-[#0D1B3E] mb-1">{occ.title}</div>
            ...
            <div className="max-w-3xl mx-auto">
              <div className="text-xs font-bold text-[#C47B12] uppercase tracking-widest mb-3">How to Use JobMaze</div>
              <h3 className="text-3xl font-black text-[#0D1B3E] tracking-tight mb-10 text-center">Find the right trucking LMIA in 3 steps</h3>
              <div className="space-y-6">
                {[
                  ...
                  <div key={i} className="flex gap-6 items-center p-6 bg-gray-50 rounded-2xl border border-gray-100">
                    <div className="w-12 h-12 rounded-full bg-[#FEF0D7] border border-[#C47B12]/30 flex items-center justify-center font-black text-[#C47B12] text-xl flex-shrink-0">{step.n}</div>
                    <div>
                      <div className="text-lg font-bold text-[#0D1B3E] mb-1">{step.t}</div>
        ...
        <section className="bg-[#0D1B3E] py-24 px-6 text-center border-t-4 border-[#F5A623]">
          <div className="max-w-2xl mx-auto">
             ...
             <Link 
                href="/sign-up"
                className="bg-[#F5A623] hover:bg-[#F5A623]/90 text-[#0D1B3E] font-bold px-10 py-5 rounded-full transition-all inline-flex items-center gap-2 hover:-translate-y-1 text-lg"
              >
