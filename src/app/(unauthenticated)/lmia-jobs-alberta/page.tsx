            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3 mb-10">
                {['Calgary', 'Edmonton', 'Red Deer', 'Lethbridge', 'Fort McMurray', 'Grande Prairie', 'Medicine Hat', 'Banff'].map((city, idx) => (
                  <Link
                    key={idx}
                    href={`/search?province=alberta&city=${city.toLowerCase()}`}
                    className="bg-white border border-gray-200 hover:border-blue-400 hover:text-blue-600 text-gray-700 px-5 py-2.5 rounded-full text-sm font-semibold transition-all shadow-sm"
                  >
                    {city}
                  </Link>
                ))}
              ...
              <div className="bg-white border border-gray-200 shadow-sm rounded-2xl p-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center text-sm">
                    ...
                    <span className="font-bold text-gray-900">1,900+</span>
                  </div>
                  <div className="w-full h-px bg-gray-100" />
                  <div className="flex justify-between items-center text-sm">
                    <span className="text-gray-500">Top occupation category</span>
                    <span className="font-bold text-gray-900">Oil & Gas / Trades</span>
                  </div>
                  <div className="w-full h-px bg-gray-100" />
                  <div className="flex justify-between items-center text-sm">
