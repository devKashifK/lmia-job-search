  ...
  return (
    <div className="min-h-screen bg-#F5F7FA flex flex-col">
      ...
      <main className="flex-1">
        {/* HERO SECTION */}
        <section className="bg-brand-900 pt-28 pb-20 px-6 relative overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-16 items-center relative z-10">
            <div className="flex-1">
              <div className="inline-flex items-center gap-2 bg-emerald-100/50 border border-emerald-100 text-emerald-500 rounded-full px-4 py-1.5 text-xs font-bold tracking-widest uppercase mb-6">
                📋 Updated 2026
              </div>
              ...
              <Link 
                href="/sign-up"
                className="bg-amber-400 hover:bg-amber-400/90 text-brand-900 font-bold px-10 py-4 rounded-full transition-all inline-flex items-center gap-3 hover:-translate-y-0.5 shadow-xl shadow-amber-50"
              >
        ...
        <div className="max-w-6xl mx-auto px-6 py-12">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-5 mb-8 flex flex-wrap gap-4 items-center shadow-sm relative z-20">
             <div className="relative flex-1 min-w-[240px]">
               ...
               <input type="text" placeholder="Search employer name or industry…" className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-700 outline-none focus:border-brand-600 transition-all" />
             </div>
             
             <div className="flex items-center gap-3">
                <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest hidden sm:block">Province</span>
                <select className="bg-gray-50 border border-gray-200 rounded-xl px-4 py-2.5 text-sm text-gray-700 outline-none focus:border-brand-600 cursor-pointer appearance-none min-w-[140px]">
             ...
             <span className="text-xs text-gray-400 ml-auto hidden xl:inline-block font-medium">
               Showing preview data · <Link href="/sign-up" className="text-brand-600 hover:underline font-bold">Sign up for full access</Link>
             </span>
          </div>
          ...
          <div className="relative z-10">
            <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm">
               {/* Table Header */}
               <div className="grid grid-cols-12 bg-brand-900 p-5 gap-4 hidden md:grid border-b border-white/5">
               ...
               <div className="divide-y divide-gray-50">
                 {[
                   { name: 'Saskatchewan Health Authority', location: 'Regina, Saskatchewan', prov: 'SK', ind: 'Healthcare', count: 84, pct: 97, color: 'bg-emerald-700' },
                   { name: 'Vancouver Coastal Health', location: 'Vancouver, British Columbia', prov: 'BC', ind: 'Healthcare', count: 61, pct: 94, color: 'bg-emerald-700' },
                   { name: 'Pembina Pipeline Corporation', location: 'Calgary, Alberta', prov: 'AB', ind: 'Oil & Gas', count: 47, pct: 91, color: 'bg-emerald-700' },
                   { name: 'EllisDon Corporation', location: 'Toronto, Ontario', prov: 'ON', ind: 'Construction', count: 38, pct: 89, color: 'bg-emerald-700' },
                   { name: 'XTL Transport Inc', location: 'Mississauga, Ontario', prov: 'ON', ind: 'Trucking', count: 33, pct: 85, color: 'bg-brand-600' },
                 ].map((row, i) => (
            ...
            {/* GATE OVERLAY */}
            <div className="w-full absolute bottom-0 left-0 bg-gradient-to-t from-gray-50 via-gray-50/98 to-transparent pt-40 pb-6 flex flex-col items-center justify-end -mb-8 z-30">
          ...
          <div className="mt-24 md:mt-32 relative z-20">
             ...
             <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  ...
                  <Link key={i} href={s.link} className="bg-white border border-gray-100 rounded-2xl p-6 text-center hover:border-brand-200 hover:shadow-xl hover:-translate-y-1 transition-all group">
                    <div className="text-4xl mb-4 transform group-hover:scale-110 transition-transform duration-300 inline-block">{s.icon}</div>
                    <div className="font-bold text-brand-900 text-[15px] mb-1">{s.name}</div>
          ...
          <div className="mt-24 pt-12 border-t border-gray-100 relative z-20">
             ...
             <div className="flex flex-wrap gap-3">
               <Link href="/what-is-lmia" className="bg-white border border-gray-200 text-gray-700 hover:text-brand-600 hover:border-brand-200 px-6 py-2.5 rounded-full text-xs font-bold transition-all shadow-sm">📋 What is LMIA?</Link>
               <Link href="/lmia-processing-time" className="bg-white border border-gray-200 text-gray-700 hover:text-brand-600 hover:border-brand-200 px-6 py-2.5 rounded-full text-xs font-bold transition-all shadow-sm">⏱ LMIA Processing Times</Link>
               <Link href="/lmia-jobs-ontario" className="bg-white border border-gray-200 text-gray-700 hover:text-brand-600 hover:border-brand-200 px-6 py-2.5 rounded-full text-xs font-bold transition-all shadow-sm">🏙️ LMIA Jobs Ontario</Link>
               <Link href="/lmia-jobs-saskatchewan" className="bg-white border border-gray-200 text-gray-700 hover:text-brand-600 hover:border-brand-200 px-6 py-2.5 rounded-full text-xs font-bold transition-all shadow-sm">🌾 LMIA Jobs Saskatchewan</Link>
               <Link href="/for-immigration-consultants" className="bg-white border border-gray-200 text-gray-700 hover:text-brand-600 hover:border-brand-200 px-6 py-2.5 rounded-full text-xs font-bold transition-all shadow-sm">⚖️ For RCICs</Link>
             </div>
          </div>
