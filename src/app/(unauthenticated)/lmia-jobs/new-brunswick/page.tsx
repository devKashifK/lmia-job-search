      ...
      <main className="flex-1">
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-[56px] font-black text-white leading-[1.1] tracking-tight mb-6">
                LMIA Jobs in <span className="text-pink-400">New Brunswick</span>
              </h1>
              ...
              <div className="flex flex-wrap items-center gap-4">
                <Link
                  href="/lmia-jobs?province=new-brunswick"
            ...
            <div className="relative">
              <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-6 md:p-8 shadow-2xl">
                ...
                <div className="space-y-4">
                  {[
                    { title: 'Fish Plant Worker', employer: 'Grand Manan Seafood', location: 'Grand Manan, NB', wage: '$17–21/hr', noc: '94142', icon: <Fish className="w-5 h-5 text-pink-400" /> },
                    { title: 'Long-Haul Truck Driver', employer: 'Day & Ross Inc', location: 'Hartland, NB', wage: '$25–32/hr', noc: '73300', icon: <Truck className="w-5 h-5 text-pink-400" /> },
                    { title: 'Registered Nurse', employer: 'Horizon Health Network', location: 'Moncton, NB', wage: '$35–42/hr', noc: '31301', icon: <Stethoscope className="w-5 h-5 text-pink-400" /> },
                    { title: 'General Labourer', employer: 'J.D. Irving, Limited', location: 'Saint John, NB', wage: '$18–24/hr', noc: '95101', icon: <Anchor className="w-5 h-5 text-pink-400" /> },
                  ].map((job, i) => (
        ...
        <section className="py-24 px-6">
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-[1fr_350px] gap-16">
            <div>
              <div className="text-xs font-black text-pink-600 uppercase tracking-widest mb-3 italic">Regional Overview</div>
              ...
              <div className="mt-8 flex flex-wrap items-center justify-center gap-4 py-8 border-y border-slate-100">
                {['Moncton', 'Saint John', 'Fredericton', 'Dieppe', 'Edmundston'].map((city, i) => (
                  <Link
                    key={i}
                    href={`/lmia-jobs?province=new-brunswick&city=${city.toLowerCase()}`}
                    className="text-sm font-bold text-slate-400 hover:text-pink-600 transition-colors uppercase tracking-[0.2em]"
                  >
                    {city}
                  </Link>
                ))}
            ...
            <aside className="space-y-6">
              <div className="bg-pink-600 rounded-[2rem] p-8 text-white shadow-2xl shadow-pink-600/20">
