    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="bg-brand-900 pt-40 pb-16 px-6 relative overflow-hidden">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_50%_at_80%_50%,rgba(184,58,110,0.15)_0%,transparent_55%)] pointer-events-none" />
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
            <div>
              ...
              <div className="inline-flex items-center gap-2 bg-pink-500/10 border border-pink-500/20 text-pink-400 rounded-full px-4 py-1.5 text-xs font-bold tracking-widest uppercase mb-6">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-[56px] font-black text-white leading-[1.1] tracking-tight mb-6">
                LMIA Jobs in <span className="text-pink-400">Hospitality</span>
              </h1>
              ...
              <div className="grid grid-cols-3 gap-4 mb-10">
                ...
                <div className="bg-white/5 border border-white/10 rounded-xl p-4 text-center">
                  <div className="text-exl font-black text-white">TEER 2-4</div>
              ...
              <div className="flex flex-wrap items-center gap-4">
                <Link
                  href="/lmia-jobs?industry=hospitality"
                  className="bg-pink-500 hover:bg-pink-600 text-white font-bold px-8 py-4 rounded-full transition-all inline-flex items-center gap-2 hover:-translate-y-1 shadow-lg shadow-pink-500/20"
                >
            ...
            <div className="relative">
              <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-6 md:p-8 shadow-2xl">
                <div className="text-xs font-black tracking-widest uppercase text-pink-400 mb-6 flex items-center gap-2">
                ...
                <div className="space-y-4">
                  {[
                    { title: 'Restaurant Cook', employer: 'Recipe Unlimited', location: 'Toronto, ON', wage: '$19–24/hr', noc: '63200', icon: <Utensils className="w-5 h-5 text-pink-400" /> },
                    { title: 'Food Service Supervisor', employer: 'Tim Hortons', location: 'Edmonton, AB', wage: '$18–22/hr', noc: '62020', icon: <Coffee className="w-5 h-5 text-pink-400" /> },
                    { title: 'Hotel Front Desk', employer: 'Marriott Halifax', location: 'Halifax, NS', wage: '$18–22/hr', noc: '64314', icon: <Hotel className="w-5 h-5 text-pink-400" /> },
                    { title: 'Baker', employer: 'Cobs Bread', location: 'Vancouver, BC', wage: '$20–25/hr', noc: '63210', icon: <Utensils className="w-5 h-5 text-pink-400" /> },
                  ].map((job, i) => (
                    <div key={i} className="bg-white/5 hover:bg-white/10 border border-white/10 rounded-2xl p-4 flex gap-4 items-center transition-all cursor-default">
                      ...
                      <Badge className="bg-pink-500/20 text-pink-400 border border-pink-500/30 text-[10px] font-black uppercase tracking-wider">LMIA Approved</Badge>
                    </div>
                  ))}
                </div>

                <div className="mt-6 bg-pink-500/10 border border-pink-500/20 border-dashed rounded-2xl p-4 text-center">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
              <div className="max-w-xl">
                <div className="text-xs font-black text-pink-600 uppercase tracking-widest mb-3">Service Occupations</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {hospitalityOccupations.map((occ, i) => (
                <div key={i} className="group bg-white border border-slate-200 rounded-[2rem] p-6 pb-8 hover:-translate-y-2 hover:border-pink-400/30 hover:shadow-2xl hover:shadow-slate-100 transition-all duration-300 flex flex-col items-center text-center">
                  <div className="w-16 h-16 rounded-[1.25rem] bg-pink-50 group-hover:bg-pink-500 transition-all duration-300 flex items-center justify-center mb-6">
                    {i === 0 ? <Utensils className="w-8 h-8 text-pink-500 group-hover:text-white" /> : i === 1 ? <Coffee className="w-8 h-8 text-pink-500 group-hover:text-white" /> : i === 2 ? <Hotel className="w-8 h-8 text-pink-500 group-hover:text-white" /> : <IceCream className="w-8 h-8 text-pink-500 group-hover:text-white" />}
                  </div>
                  ...
                  <Badge className="bg-slate-50 text-pink-600 border-pink-100 font-black uppercase text-[9px] tracking-wider py-1 px-4">
                    {occ.demand} Demand
                  </Badge>
                </div>
              ))}
            ...
            {/* TIP BOX */}
            <div className="mt-12 bg-pink-50/50 border border-pink-100 rounded-[2.5rem] p-8 md:p-14 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-48 h-48 bg-pink-400/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
              <div className="relative z-10 flex flex-col md:flex-row items-center gap-12">
                <div className="text-5xl shrink-0">💡</div>
                <div className="max-w-xl">
                  <h4 className="text-xl font-bold text-brand-900 mb-4 tracking-tight uppercase tracking-widest text-sm text-pink-600">Expert Guidance</h4>
        ...
        {/* BOTTOM CTA */}
        <section className="bg-brand-900 py-24 px-6 text-center border-t-4 border-pink-500">
          <div className="max-w-2xl mx-auto">
            <div className="text-xs font-black text-pink-400 uppercase tracking-widest mb-4">Start your search</div>
            ...
            <Link
              href="/sign-up"
              className="bg-pink-500 hover:bg-pink-600 text-white font-black px-12 py-5 rounded-full transition-all inline-flex items-center gap-3 hover:-translate-y-1 shadow-2xl shadow-pink-500/40 text-lg"
            >
