        ...
        <div className="min-h-screen bg-slate-50/50 flex flex-col items-center p-6 md:p-12">
            ...
            <header className="w-full max-w-4xl flex items-center justify-between mb-8">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-sm font-bold text-slate-900 uppercase tracking-tighter leading-none">JobMaze Portal</h1>
                ...
                <div className="flex items-center gap-3 bg-white px-4 py-2 rounded-xl border border-slate-100 shadow-sm">
                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Presented By</span>
                    ...
                    {agency.logo_url ? (
                        <div className="flex items-center gap-2">
                             ...
                             <span className="text-xs font-bold text-slate-900 uppercase truncate max-w-[120px]">{agency.company_name}</span>
                        </div>
                    ) : (
                        <span className="text-xs font-bold text-slate-900 uppercase">{agency.company_name}</span>
                    )}
                </div>
            </header>
            ...
            >
                <div className="bg-amber-50 border border-amber-100 rounded-xl p-4 mb-6 flex items-center gap-4">
                    ...
                    <div>
                        <p className="text-[10px] font-bold text-amber-900 uppercase tracking-widest leading-none mb-1">Confidential Professional Profile</p>
            ...
            <footer className="w-full max-w-4xl mt-12 pt-8 border-t border-slate-200 flex flex-col md:flex-row items-center justify-between gap-6 opacity-40 grayscale">
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-[10px] font-bold text-slate-900 uppercase tracking-widest">JobMaze Global Recruitment Network</span>
                </div>
