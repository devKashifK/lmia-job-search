          ...
          <div className="max-w-6xl mx-auto flex items-center gap-2 whitespace-nowrap">
            ...
            {[
              ...
              <button
                ...
                className={`text-[13px] font-bold px-4 py-2 rounded-full transition-all ${activeSection === link.id
              ...
              <nav className="flex flex-col gap-1">
                {[
                  ...
                  <button
                    key={link.id}
                    onClick={() => scrollToSection(link.id)}
                    className={`flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-all ${activeSection === link.id
