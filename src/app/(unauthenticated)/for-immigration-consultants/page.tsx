      ...
      <main className="flex-1">
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-[56px] font-black text-white leading-[1.1] tracking-tight mb-6">
                The <span className="text-[#F5A623]">LMIA search tool</span> your practice has been missing
              </h1>
            ...
            <div className="relative space-y-3">
              ...
              <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-2xl animate-in fade-in slide-in-from-bottom-4 duration-700">
                <div className="text-[10px] font-bold tracking-widest uppercase text-[#78B4E8] mb-4 flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full bg-[#1D6FBF] animate-pulse" />
                  Live LMIA Search
                </div>
                
                <div className="flex flex-wrap gap-2 mb-4">
                  <Badge variant="outline" className="bg-[#D6E6F7] text-[#1D6FBF] border-[#1D6FBF]/30 uppercase text-[10px] tracking-wider py-1 px-2.5">Saskatchewan</Badge>
                  <Badge variant="outline" className="bg-[#D6E6F7] text-[#1D6FBF] border-[#1D6FBF]/30 uppercase text-[10px] tracking-wider py-1 px-2.5">Healthcare</Badge>
                  <Badge variant="outline" className="bg-[#D6E6F7] text-[#1D6FBF] border-[#1D6FBF]/30 uppercase text-[10px] tracking-wider py-1 px-2.5">TEER 1–2</Badge>
                ...
                <div className="space-y-1.5">
                  <div className="bg-white/[0.06] rounded-lg p-2.5 flex items-center gap-3">
                    <div className="w-2 h-2 rounded-full bg-[#4ECBA3] flex-shrink-0" />
                    <div className="text-sm font-medium text-white truncate flex-1">Registered Nurse — Regina Health Authority</div>
                    <Badge className="bg-[#0F7B5E]/30 text-[#4ECBA3] border border-[#4ECBA3]/30 whitespace-nowrap text-[10px]">LMIA Approved</Badge>
                  </div>
                  <div className="bg-white/[0.06] rounded-lg p-2.5 flex items-center gap-3">
                    <div className="w-2 h-2 rounded-full bg-[#4ECBA3] flex-shrink-0" />
                  ...
                  <div className="bg-white/[0.06] rounded-lg p-2.5 flex items-center gap-3">
                    <div className="w-2 h-2 rounded-full bg-[#78B4E8] flex-shrink-0" />
                    <div className="text-sm font-medium text-white truncate flex-1">Medical Lab Technician — SK Health Board</div>
                    <Badge className="bg-[#1D6FBF]/30 text-[#78B4E8] border border-[#78B4E8]/30 whitespace-nowrap text-[10px]">LMIA Eligible</Badge>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-2xl animate-in fade-in slide-in-from-bottom-4 duration-700 delay-150 fill-mode-both">
                <div className="text-[10px] font-bold tracking-widest uppercase text-[#78B4E8] mb-3">
                  ⏱ Time Saved This Week
                </div>
                <div className="bg-[#F5A623]/15 border border-[#F5A623]/30 rounded-xl p-3 px-4 flex items-center gap-4">
                  <div className="text-3xl font-black text-[#F5A623]">4.8h</div>
              ...
              <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-2xl animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300 fill-mode-both">
                ...
                <div className="bg-[#4ECBA3]/10 border border-[#4ECBA3]/20 rounded-xl p-3 px-4 flex items-center gap-3">
                  <div className="w-2 h-2 rounded-full bg-[#4ECBA3]" />
                  <div className="text-sm font-medium text-white flex-1">3 strong matches found in Saskatchewan</div>
                  <Badge className="bg-[#0F7B5E]/30 text-[#4ECBA3] border border-[#4ECBA3]/30 whitespace-nowrap text-[10px]">Export Ready</Badge>
                </div>
              </div>
        ...
        <section className="py-24 px-6 bg-gray-50 border-b border-gray-100">
          <div className="max-w-6xl mx-auto">
            <div className="text-xs font-bold text-[#1D6FBF] uppercase tracking-widest mb-3">The Problem</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              <div className="bg-white border text-center border-gray-200 rounded-2xl p-8 relative overflow-hidden group hover:border-red-200 transition-colors">
                ...
                <h3 className="text-lg font-bold text-[#0D1B3E] mb-3">Hours lost per client</h3>
              ...
              <div className="bg-white border text-center border-gray-200 rounded-2xl p-8 relative overflow-hidden group hover:border-red-200 transition-colors">
                ...
                <h3 className="text-lg font-bold text-[#0D1B3E] mb-3">Scattered data sources</h3>
                <p className="text-sm text-gray-500 leading-relaxed">
              ...
              <div className="bg-white border text-center border-gray-200 rounded-2xl p-8 relative overflow-hidden group hover:border-red-200 transition-colors">
                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-red-400 to-red-500" />
                <div className="text-4xl mb-4">📉</div>
                <h3 className="text-lg font-bold text-[#0D1B3E] mb-3">Stale listings waste effort</h3>
                <p className="text-sm text-gray-500 leading-relaxed">
            ...
            <div className="flex justify-center mb-12 relative">
               <div className="bg-white px-6 py-2 text-sm font-bold text-[#1D6FBF] tracking-widest uppercase relative z-10 border border-[#D6E6F7] rounded-full">↓ JobMaze solves all three ↓</div>
               <div className="absolute top-1/2 left-0 w-full h-px bg-gray-200" />
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white border text-center border-[#D6E6F7] rounded-2xl p-8 relative overflow-hidden group hover:border-[#1D6FBF]/40 transition-colors shadow-sm">
                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#1D6FBF] to-[#4ECBA3]" />
                <div className="text-4xl mb-4">⚡</div>
                <h3 className="text-lg font-bold text-[#0D1B3E] mb-3">5-minute LMIA searches</h3>
                <p className="text-sm text-gray-500 leading-relaxed">
              ...
              <div className="bg-white border text-center border-[#D6E6F7] rounded-2xl p-8 relative overflow-hidden group hover:border-[#1D6FBF]/40 transition-colors shadow-sm">
                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#1D6FBF] to-[#4ECBA3]" />
                <div className="text-4xl mb-4">🎯</div>
                <h3 className="text-lg font-bold text-[#0D1B3E] mb-3">One centralized database</h3>
                <p className="text-sm text-gray-500 leading-relaxed">
              ...
              <div className="bg-white border text-center border-[#D6E6F7] rounded-2xl p-8 relative overflow-hidden group hover:border-[#1D6FBF]/40 transition-colors shadow-sm">
                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#1D6FBF] to-[#4ECBA3]" />
                <div className="text-4xl mb-4">🔄</div>
                <h3 className="text-lg font-bold text-[#0D1B3E] mb-3">Updated every 24 hours</h3>
                <p className="text-sm text-gray-500 leading-relaxed">
        ...
        <section className="py-24 px-6 bg-white border-b border-gray-100" id="features">
          <div className="max-w-6xl mx-auto">
            <div className="text-xs font-bold text-[#1D6FBF] uppercase tracking-widest mb-3">Features for RCICs</div>
            ...
            <div className="space-y-24">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div>
                  <div className="text-xs font-bold text-[#1D6FBF] uppercase tracking-widest mb-3">Smart Search</div>
                  <h3 className="text-3xl font-black text-[#0D1B3E] tracking-tight mb-4">NOC & TEER-matched job search</h3>
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-[#4ECBA3] flex-shrink-0 mt-0.5" /><span className="text-gray-700">Search by NOC code, job title, or keyword</span></li>
                    <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-[#4ECBA3] flex-shrink-0 mt-0.5" /><span className="text-gray-700">Filter by TEER 0–5 for pathway eligibility</span></li>
                    <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-[#4ECBA3] flex-shrink-0 mt-0.5" /><span className="text-gray-700">Cross-reference with Express Entry CRS job offer requirements</span></li>
                    <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-[#4ECBA3] flex-shrink-0 mt-0.5" /><span className="text-gray-700">Save searches per client with custom labels</span></li>
                  </ul>
                </div>
                <div className="bg-gray-50 border border-gray-200 rounded-2xl p-6 shadow-sm">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4 px-2">
                    <Badge variant="outline" className="bg-[#D6E6F7] text-[#1D6FBF] border-[#1D6FBF]/30 uppercase text-[10px] tracking-wider py-1">NOC 31301</Badge>
                    <Badge variant="outline" className="bg-[#D6E6F7] text-[#1D6FBF] border-[#1D6FBF]/30 uppercase text-[10px] tracking-wider py-1">TEER 1</Badge>
                    <Badge variant="outline" className="bg-[#D6E6F7] text-[#1D6FBF] border-[#1D6FBF]/30 uppercase text-[10px] tracking-wider py-1">Ontario</Badge>
                  ...
                  <div className="space-y-2.5">
                    <div className="bg-white border border-gray-200 rounded-xl p-3 flex items-center gap-3">
                      <div className="w-10 h-10 rounded-lg bg-[#D6E6F7] flex items-center justify-center flex-shrink-0">🏥</div>
                      ...
                      <Badge className="bg-[#D0EFE6] text-[#0F7B5E] border border-[#0F7B5E]/20 whitespace-nowrap text-[10px]">LMIA ✓</Badge>
                    </div>
                    <div className="bg-white border border-gray-200 rounded-xl p-3 flex items-center gap-3">
                      <div className="w-10 h-10 rounded-lg bg-[#D6E6F7] flex items-center justify-center flex-shrink-0">🏥</div>
                      <div className="flex-1 min-w-0">
                    ...
                    <div className="bg-white border border-gray-200 rounded-xl p-3 flex items-center gap-3">
                      ...
                      <Badge className="bg-[#D6E6F7] text-[#1D6FBF] border border-[#1D6FBF]/20 whitespace-nowrap text-[10px]">Eligible</Badge>
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div className="order-2 lg:order-1 bg-gray-50 border border-gray-200 rounded-2xl p-6 shadow-sm">
                  ...
                  <div className="space-y-2.5">
                    <div className="bg-white border border-[#1D6FBF]/30 shadow-sm rounded-xl p-3 flex items-center gap-3">
                      ...
                      <Badge className="bg-[#D0EFE6] text-[#0F7B5E] border border-[#0F7B5E]/20 whitespace-nowrap text-[10px]">Active</Badge>
                    </div>
                    <div className="bg-white border border-gray-200 rounded-xl p-3 flex items-center gap-3">
                      <div className="w-10 h-10 flex items-center justify-center text-xl">👤</div>
                      <div className="flex-1 min-w-0">
                      ...
                      <Badge className="bg-[#D6E6F7] text-[#1D6FBF] border border-[#1D6FBF]/20 whitespace-nowrap text-[10px]">In Progress</Badge>
                    </div>
                    <div className="bg-white border border-gray-200 rounded-xl p-3 flex items-center gap-3">
                      <div className="w-10 h-10 flex items-center justify-center text-xl">👤</div>
                      <div className="flex-1 min-w-0">
                      ...
                      <Badge className="bg-[#FEF0D7] text-[#C47B12] border border-[#C47B12]/20 whitespace-nowrap text-[10px]">Export Done</Badge>
                    </div>
                  </div>
                </div>
                <div className="order-1 lg:order-2">
                  <div className="text-xs font-bold text-[#1D6FBF] uppercase tracking-widest mb-3">Client Management</div>
                  <h3 className="text-3xl font-black text-[#0D1B3E] tracking-tight mb-4">Manage 20 clients, not 20 tabs</h3>
                  <p className="text-gray-500 text-lg mb-6 leading-relaxed">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-[#4ECBA3] flex-shrink-0 mt-0.5" /><span className="text-gray-700">Save unlimited named searches (one per client)</span></li>
                    <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-[#4ECBA3] flex-shrink-0 mt-0.5" /><span className="text-gray-700">Tag jobs as Reviewed, Shortlisted, or Contacted</span></li>
                    <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-[#4ECBA3] flex-shrink-0 mt-0.5" /><span className="text-gray-700">Export PDF or CSV reports for client presentations</span></li>
                    <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-[#4ECBA3] flex-shrink-0 mt-0.5" /><span className="text-gray-700">90-day search history automatically archived</span></li>
                  </ul>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div>
                  <div className="text-xs font-bold text-[#1D6FBF] uppercase tracking-widest mb-3">Employer Intelligence</div>
                  <h3 className="text-3xl font-black text-[#0D1B3E] tracking-tight mb-4">Full employer LMIA history at a glance</h3>
                  <p className="text-gray-500 text-lg mb-6 leading-relaxed">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-[#4ECBA3] flex-shrink-0 mt-0.5" /><span className="text-gray-700">View full LMIA application history per employer</span></li>
                    <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-[#4ECBA3] flex-shrink-0 mt-0.5" /><span className="text-gray-700">See approval vs. rejection rates</span></li>
                    <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-[#4ECBA3] flex-shrink-0 mt-0.5" /><span className="text-gray-700">Compliance flags from ESDC non-compliance records</span></li>
                    <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-[#4ECBA3] flex-shrink-0 mt-0.5" /><span className="text-gray-700">Direct employer contact details (name, phone, email)</span></li>
                  </ul>
                </div>
                <div className="bg-gray-50 border border-gray-200 rounded-2xl p-6 shadow-sm">
                  <div className="flex px-2 pb-4 mb-4 border-b border-gray-200 items-center justify-start gap-1">
                  ...
                  <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
                     <div className="text-base font-bold text-[#0D1B3E] mb-1">Regina Health Authority</div>
                     ...
                     <div className="grid grid-cols-3 gap-3">
                        <div className="bg-[#D0EFE6] rounded-xl p-3 text-center">
                          <div className="text-xl font-black text-[#0F7B5E]">24</div>
                          <div className="text-[10px] text-[#0F7B5E] font-medium uppercase mt-1 tracking-wider">Total LMIAs</div>
                        </div>
                        <div className="bg-[#D6E6F7] rounded-xl p-3 text-center">
                           <div className="text-xl font-black text-[#1D6FBF]">96%</div>
                           <div className="text-[10px] text-[#1D6FBF] font-medium uppercase mt-1 tracking-wider">Approval Rate</div>
                        </div>
                        <div className="bg-[#FEF0D7] rounded-xl p-3 text-center">
                           <div className="text-xl font-black text-[#C47B12]">2026</div>
                           <div className="text-[10px] text-[#C47B12] font-medium uppercase mt-1 tracking-wider">Last Active</div>
                        </div>
                     </div>
                  </div>
                </div>
        ...
        {/* WORKFLOW */}
        <section className="bg-[#0D1B3E] py-24 px-6 border-b border-white/5" id="workflow">
          <div className="max-w-6xl mx-auto">
            <div className="text-center max-w-2xl mx-auto mb-20">
               <div className="text-xs font-bold text-[#78B4E8] uppercase tracking-widest mb-3">How It Works</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-6 relative">
              <div className="hidden md:block absolute top-8 left-[10%] right-[10%] h-0.5 bg-gradient-to-r from-[#1D6FBF] to-[#4ECBA3] z-0" />
              ...
              {[
                ...
                <div key={i} className="text-center relative z-10">
                   <div className="w-16 h-16 rounded-full bg-[#1A2F5E] border-2 border-[#1D6FBF] flex items-center justify-center font-black text-white text-xl mx-auto mb-6 shadow-xl">
                     {s.step}
                   </div>
        ...
        <section className="py-24 px-6 bg-gray-50 border-t border-gray-100">
           <div className="max-w-6xl mx-auto">
             <div className="text-center max-w-2xl mx-auto mb-16">
               <div className="text-xs font-bold text-[#1D6FBF] uppercase tracking-widest mb-3">What RCICs Say</div>
               <h2 className="text-3xl md:text-4xl font-black text-[#0D1B3E] tracking-tight mb-4">
             ...
             <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
               <div className="bg-white border border-gray-200 rounded-2xl p-8 hover:border-blue-200 transition-colors shadow-sm">
                 <div className="text-[#F5A623] text-sm tracking-widest mb-4">★★★★★</div>
                 ...
                 <div className="flex items-center gap-4">
                   <div className="w-10 h-10 rounded-full bg-[#D6E6F7] text-[#1D6FBF] flex items-center justify-center font-bold text-sm tracking-tight">SP</div>
                   <div>
               ...
               <div className="bg-white border border-gray-200 rounded-2xl p-8 hover:border-blue-200 transition-colors shadow-sm">
                 ...
                 <div className="flex items-center gap-4">
                   <div className="w-10 h-10 rounded-full bg-[#D6E6F7] text-[#1D6FBF] flex items-center justify-center font-bold text-sm tracking-tight">RK</div>
                   <div>
               ...
               <div className="bg-white border border-gray-200 rounded-2xl p-8 hover:border-blue-200 transition-colors shadow-sm">
                 ...
                 <div className="flex items-center gap-4">
                   <div className="w-10 h-10 rounded-full bg-[#D6E6F7] text-[#1D6FBF] flex items-center justify-center font-bold text-sm tracking-tight">AM</div>
                   <div>
