      ...
      <main className="flex-1">
              ...
              <div className="bg-white/[0.03] backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-2xl">
                ...
                <div className="mt-4 bg-amber-50 border border-amber-200 border-dashed rounded-xl p-4 text-center">
                  <p className="text-sm text-amber-400">
                    🔒 Sign up free to see full listings with employer names, wages & contact details. <Link href="/sign-up" className="font-bold underline hover:text-amber-400/80">Start free trial</Link>
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-20 px-6 bg-white border-b border-gray-100">
          <div className="max-w-5xl mx-auto">
            <div className="text-center max-w-2xl mx-auto mb-16">
              <div className="text-xs font-bold text-emerald-700 uppercase tracking-widest mb-3">In-Demand Occupations</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                { title: 'Registered Nurse', noc: 'NOC 31301', teer: 'TEER 1', demand: 'Very High demand', demandColor: 'bg-emerald-50 text-emerald-700' },
                { title: 'Licensed Practical Nurse', noc: 'NOC 32101', teer: 'TEER 2', demand: 'Very High demand', demandColor: 'bg-emerald-50 text-emerald-700' },
                { title: 'Personal Support Worker', noc: 'NOC 44101', teer: 'TEER 4', demand: 'High demand', demandColor: 'bg-brand-50 text-brand-600' },
                { title: 'Medical Laboratory Technician', noc: 'NOC 32120', teer: 'TEER 2', demand: 'High demand', demandColor: 'bg-brand-50 text-brand-600' },
                { title: 'Pharmacist', noc: 'NOC 31120', teer: 'TEER 1', demand: 'Medium demand', demandColor: 'bg-amber-50 text-amber-600' },
                { title: 'Physiotherapist', noc: 'NOC 31120', teer: 'TEER 1', demand: 'Medium demand', demandColor: 'bg-amber-50 text-amber-600' },
              ].map((occ, i) => (
        ...
        <section className="py-24 px-6 bg-gray-50">
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
              <div className="text-xs font-bold text-emerald-700 uppercase tracking-widest mb-3">Where to Search</div>
              <h3 className="text-3xl font-black text-brand-900 tracking-tight mb-6">Top provinces hiring in Healthcare</h3>
            ...
            {/* How to use JobMaze */}
            <div>
              <div className="text-xs font-bold text-emerald-700 uppercase tracking-widest mb-3">How to Use JobMaze</div>
              <h3 className="text-3xl font-black text-brand-900 tracking-tight mb-6">Find the right healthcare LMIA in 3 steps</h3>

              <div className="space-y-8 mt-10">
                <div className="flex gap-5 items-start">
                  <div className="w-10 h-10 rounded-full bg-emerald-50 border border-emerald-200 flex items-center justify-center font-black text-emerald-700 flex-shrink-0">1</div>
                  <div>
                    <div className="text-base font-bold text-brand-900 mb-2">Filter by industry</div>
                    <div className="text-sm text-gray-500 leading-relaxed">Select Healthcare in the industry filter on JobMaze</div>
                  </div>
                </div>
                <div className="flex gap-5 items-start">
                  <div className="w-10 h-10 rounded-full bg-emerald-50 border border-emerald-200 flex items-center justify-center font-black text-emerald-700 flex-shrink-0">2</div>
                  <div>
                    <div className="text-base font-bold text-brand-900 mb-2">Add your NOC code</div>
                ...
                <div className="flex gap-5 items-start">
                  <div className="w-10 h-10 rounded-full bg-emerald-50 border border-emerald-200 flex items-center justify-center font-black text-emerald-700 flex-shrink-0">3</div>
                  <div>
                    <div className="text-base font-bold text-brand-900 mb-2">Check LMIA status</div>
