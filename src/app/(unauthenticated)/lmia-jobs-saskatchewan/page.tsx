...
export default function SaskatchewanLMIAJobs() {
  return (
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
            <div>
              ...
              <div className="grid grid-cols-3 gap-4 mb-10">
                ...
                <div className="bg-white/5 border border-white/10 rounded-xl p-4 text-center">
                  <div className="text-2xl font-black text-white tracking-tight">SINP</div>
                  <div className="text-[11px] text-blue-200/60 uppercase tracking-wider mt-1 font-medium italic">Most active draws 2026</div>
                </div>
                <div className="bg-white/5 border border-white/10 rounded-xl p-4 text-center">
                  <div className="text-2xl font-black text-white tracking-tight">14+</div>
                  <div className="text-[11px] text-blue-200/60 uppercase tracking-wider mt-1 font-medium">Draws in 2026</div>
                </div>
              </div>

              <div className="flex flex-wrap items-center gap-4">
                <Link
                  href="/search/lmia/all?state=Saskatchewan&t=lmia"
            ...
            <div className="relative">
              <div className="bg-white/[0.03] backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-2xl">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  <Badge className="bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 uppercase text-[10px] tracking-wider py-1.5 px-3">Saskatchewan</Badge>
                ...
                <div className="space-y-3 relative">
                  <div className="bg-white/[0.06] hover:bg-white/10 border border-white/10 rounded-xl p-3 flex gap-4 items-center transition-colors">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="font-medium text-white text-sm truncate">Registered Nurse — Saskatchewan Health Authority</div>
                      <div className="text-xs text-blue-200/60 mt-0.5 truncate">Regina, SK · $36–44/hr · NOC 31301</div>
                    </div>
                  ...
                  <div className="bg-white/[0.06] hover:bg-white/10 border border-white/10 rounded-xl p-3 flex gap-4 items-center transition-colors">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="font-medium text-white text-sm truncate">Grain Farmer — CPS Prairie Grains</div>
                      <div className="text-xs text-blue-200/60 mt-0.5 truncate">Swift Current, SK · $22–26/hr · NOC 84100</div>
                    </div>
                    <Badge className="bg-green-500/20 text-green-400 border border-green-500/30 font-medium whitespace-nowrap text-[10px]">LMIA Approved</Badge>
                  </div>
                  <div className="bg-white/[0.06] hover:bg-white/10 border border-white/10 rounded-xl p-3 flex gap-4 items-center transition-colors">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="font-medium text-white text-sm truncate">Mining Engineer — Cameco Corporation</div>
                      <div className="text-xs text-blue-200/60 mt-0.5 truncate">Saskatoon, SK · $95–120k/yr · NOC 21330</div>
                    </div>
                    <Badge className="bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 font-medium whitespace-nowrap text-[10px]">LMIA Eligible</Badge>
                  </div>
                  <div className="bg-white/[0.06] hover:bg-white/10 border border-white/10 rounded-xl p-3 flex gap-4 items-center transition-colors">
                    <div className="w-10 h-10 rounded-lg bg-white/10 flex items-center justify-center flex-shrink-0">
                      <Briefcase className="w-5 h-5 text-gray-300" />
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="font-medium text-white text-sm truncate">Long-Haul Truck Driver — Husky Logistics</div>
                      <div className="text-xs text-blue-200/60 mt-0.5 truncate">Regina, SK · $26–32/hr · NOC 73300</div>
                    </div>
                    <Badge className="bg-green-500/20 text-green-400 border border-green-500/30 font-medium whitespace-nowrap text-[10px]">LMIA Approved</Badge>
                  </div>
                ...
                <div className="mt-4 bg-amber-50 border border-amber-200 border-dashed rounded-xl p-4 text-center">
                  <p className="text-sm text-amber-400">
                    🔒 Showing 4 of 1,100+ listings. <Link href="/sign-up" className="font-bold underline hover:text-amber-400/80">Sign up free</Link> to view all — including employer contacts & wages.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-black text-brand-900 tracking-tight mb-4">
                Where LMIA hiring is most active in Saskatchewan
              </h2>
              <p className="text-gray-500 text-lg">
                These sectors consistently post LMIA-eligible positions in Saskatchewan. Use JobMaze's industry filter to narrow your search for clients seeking roles in these expanding fields.
              </p>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
              {[
                { icon: '🏥', title: 'Healthcare', desc: 'Active LMIA hiring in Saskatchewan — filter by this sector on JobMaze' },
                { icon: '🌾', title: 'Agriculture', desc: 'Active LMIA hiring in Saskatchewan — filter by this sector on JobMaze' },
                { icon: '⛏️', title: 'Mining', desc: 'Active LMIA hiring in Saskatchewan — filter by this sector on JobMaze' },
                { icon: '🚛', title: 'Trucking', desc: 'Active LMIA hiring in Saskatchewan — filter by this sector on JobMaze' },
                { icon: '🏗️', title: 'Construction', desc: 'Active LMIA hiring in Saskatchewan — filter by this sector on JobMaze' },
              ].map((ind, i) => (
                <div key={i} className="bg-white border border-slate-200 rounded-2xl p-5 hover:-translate-y-1 hover:border-emerald-500/40 transition-all duration-300 shadow-sm">
        ...
        <section className="py-24 px-6 bg-gray-50">
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <h3 className="text-3xl font-black text-brand-900 tracking-tight mb-6">Saskatchewan Immigrant Nominee Program (SINP)</h3>
              <p className="text-gray-600 mb-8 text-lg">
                An LMIA job offer is a key component for several Saskatchewan PNP streams. Finding the right employer through JobMaze is the first step to a successful nomination for your client across active pathways.
              </p>

              <div className="bg-brand-50 border border-brand-100 rounded-2xl p-6">
                <div className="text-[13px] font-bold text-brand-600 uppercase tracking-widest mb-4">Active Streams</div>
                <div className="space-y-4">
                  {['International Skilled Worker – Employment Offer', 'International Skilled Worker – Occupations In-Demand', 'Saskatchewan Experience', 'Entrepreneur'].map((stream, idx) => (
            ...
            <div>
              ...
              <h3 className="text-3xl font-black text-brand-900 tracking-tight mb-6">Job searches by Saskatchewan city</h3>
              <p className="text-gray-600 mb-8 text-lg">
                JobMaze covers LMIA jobs in every SK city and rural municipality. Use the city filter to narrow results for your client's preferred location.
              </p>
              ...
              <div className="flex flex-wrap gap-3 mb-10">
                {['Regina', 'Saskatoon', 'Prince Albert', 'Moose Jaw', 'Swift Current'].map((city, idx) => (
                  <Link
                    key={idx}
                    href={`/search/lmia/all?state=Saskatchewan&city=${city}&t=lmia`}
                    className="bg-white border border-slate-200 hover:bg-emerald-600 hover:text-white text-slate-900 px-5 py-2.5 rounded-full text-sm font-bold transition-all shadow-sm duration-300"
                  >
                    {city}
                  </Link>
                ))}
