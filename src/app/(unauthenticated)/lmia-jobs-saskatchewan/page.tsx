          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-[52px] font-black text-white leading-[1.1] tracking-tight mb-6">
                LMIA Jobs in <span className="text-[#F5A623]">Saskatchewan</span>
              </h1>
            ...
            <div className="relative">
              <div className="bg-white/[0.03] backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-2xl">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  <Badge className="bg-[#D6E6F7] hover:bg-[#D6E6F7] text-[#1D6FBF] border-[#1D6FBF]/30 uppercase text-[10px] tracking-wider py-1.5 px-3">Saskatchewan</Badge>
                ...
                <div className="mt-4 bg-[#F5A623]/10 border border-[#F5A623]/30 border-dashed rounded-xl p-4 text-center">
                  <p className="text-sm text-[#F5A623]">
                    🔒 Showing 4 of 1,100+ listings. <Link href="/sign-up" className="font-bold underline hover:text-[#F5A623]/80">Sign up free</Link> to view all — including employer contacts & wages.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
              {[
                ...
                <div key={i} className="bg-white border border-gray-200 rounded-2xl p-5 hover:-translate-y-1 hover:border-[#B83A6E]/40 transition-all duration-300 shadow-sm">
        ...
        <section className="py-24 px-6 bg-gray-50">
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <h3 className="text-3xl font-black text-[#0D1B3E] tracking-tight mb-6">Saskatchewan Immigrant Nominee Program (SINP)</h3>
            ...
            <div>
              ...
              <h3 className="text-3xl font-black text-[#0D1B3E] tracking-tight mb-6">Job searches by Saskatchewan city</h3>
              <p className="text-gray-600 mb-8 text-lg">
