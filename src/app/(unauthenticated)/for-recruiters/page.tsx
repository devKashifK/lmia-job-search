    ...
    <div className="min-h-screen bg-gray-50 flex flex-col font-inter">
      ...
      <main className="flex-1">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 min-h-[580px]">
          {/* Left Side */}
          <div className="bg-brand-900 pt-24 pb-20 px-8 lg:px-16 flex flex-col justify-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-[56px] font-black text-white leading-[1.1] tracking-tight mb-6">
                The <span className="text-amber-400 italic">LMIA job board</span> built for Canadian recruiters
              </h1>
          ...
          {/* Right Side */}
          <div className="bg-gray-50 px-8 lg:px-16 py-16 flex flex-col justify-center border-l border-gray-200">
            ...
            <div className="flex flex-col gap-4">
              <div className="bg-white border border-gray-200 rounded-xl p-5 flex items-center gap-5 shadow-sm transform transition-transform hover:-translate-y-1">
                ...
                <div className="flex-1">
                  <div className="text-2xl font-black text-brand-900 leading-none mb-1">500+</div>
                  <div className="text-xs text-gray-500 font-medium">LMIA-active employers searchable</div>
                </div>
                <Badge variant="outline" className="bg-brand-50 text-brand-600 border-brand-100 uppercase whitespace-nowrap text-[10px]">Per export</Badge>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-5 flex items-center gap-5 shadow-sm transform transition-transform hover:-translate-y-1 delay-75">
                <div className="w-12 h-12 rounded-xl bg-brand-50 flex items-center justify-center text-2xl flex-shrink-0">👥</div>
                <div>
                  <div className="text-2xl font-black text-brand-900 leading-none mb-1">5 seats</div>
                  <div className="text-xs text-gray-500 font-medium">Multi-user team access</div>
                </div>
                <Badge variant="outline" className="bg-brand-50 text-brand-600 border-brand-100 uppercase whitespace-nowrap text-[10px]">Agency plan</Badge>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-5 flex items-center gap-5 shadow-sm transform transition-transform hover:-translate-y-1 delay-150">
                ...
                <div>
                  <div className="text-2xl font-black text-brand-900 leading-none mb-1">All 13</div>
                  <div className="text-xs text-gray-500 font-medium">Provinces & territories covered</div>
                </div>
                <Badge variant="outline" className="bg-emerald-50 text-emerald-700 border-emerald-100 uppercase whitespace-nowrap text-[10px]">Daily refresh</Badge>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-5 flex items-center gap-5 shadow-sm transform transition-transform hover:-translate-y-1 delay-200">
                ...
                <div className="flex-1">
                  <div className="text-2xl font-black text-brand-900 leading-none mb-1">CSV / XLS</div>
                  <div className="text-xs text-gray-500 font-medium">Bulk export for your ATS</div>
                </div>
                <Badge variant="outline" className="bg-amber-50 text-amber-600 border-amber-600/20 uppercase whitespace-nowrap text-[10px]">Agency only</Badge>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 px-6 bg-gray-50 border-b border-gray-200">
          <div className="max-w-5xl mx-auto">
            <div className="text-center max-w-2xl mx-auto mb-16">
              <div className="text-xs font-bold text-brand-600 uppercase tracking-widest mb-3">Use Cases</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white border border-gray-200 rounded-2xl p-8 relative overflow-hidden group hover:border-blue-200 hover:shadow-lg transition-all hover:-translate-y-1">
                ...
                <h3 className="text-xl font-bold text-brand-900 mb-3 relative z-10">TFW candidate sourcing</h3>
                ...
                <ul className="space-y-2 relative z-10">
                  <li className="flex gap-2 items-start text-[13px] text-gray-700"><span className="text-rose-500 font-bold">→</span> Filter by province, city, and industry simultaneously</li>
                  <li className="flex gap-2 items-start text-[13px] text-gray-700"><span className="text-rose-500 font-bold">→</span> View employer contact details directly</li>
                  <li className="flex gap-2 items-start text-[13px] text-gray-700"><span className="text-rose-500 font-bold">→</span> Export matched listings for candidate review</li>
                </ul>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-8 relative overflow-hidden group hover:border-blue-200 hover:shadow-lg transition-all hover:-translate-y-1">
                ...
                <h3 className="text-xl font-bold text-brand-900 mb-4">Direct Employer Pipeline</h3>
                <p className="text-sm text-gray-500 leading-relaxed mb-5 relative z-10">
                ...
                <ul className="space-y-2 relative z-10">
                  <li className="flex gap-2 items-start text-[13px] text-gray-700"><span className="text-brand-600 font-bold">→</span> Rank employers by LMIA volume and recency</li>
                  <li className="flex gap-2 items-start text-[13px] text-gray-700"><span className="text-brand-600 font-bold">→</span> Filter by sector and approval rate</li>
                  <li className="flex gap-2 items-start text-[13px] text-gray-700"><span className="text-brand-600 font-bold">→</span> Build prospect lists and export for outreach</li>
                </ul>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-8 relative overflow-hidden group hover:border-blue-200 hover:shadow-lg transition-all hover:-translate-y-1">
                ...
                <div className="text-3xl mb-4 relative z-10">📊</div>
                <h3 className="text-xl font-bold text-brand-900 mb-3 relative z-10">Market research & reporting</h3>
                <p className="text-sm text-gray-500 leading-relaxed mb-5 relative z-10">
                ...
                <ul className="space-y-2 relative z-10">
                  <li className="flex gap-2 items-start text-[13px] text-gray-700"><span className="text-rose-500 font-bold">→</span> Province-by-province LMIA volume data</li>
                  <li className="flex gap-2 items-start text-[13px] text-gray-700"><span className="text-rose-500 font-bold">→</span> Sector trending over time</li>
                  <li className="flex gap-2 items-start text-[13px] text-gray-700"><span className="text-rose-500 font-bold">→</span> Quarterly LMIA market reports (free to download)</li>
                </ul>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-8 relative overflow-hidden group hover:border-blue-200 hover:shadow-lg transition-all hover:-translate-y-1">
                ...
                <div className="text-3xl mb-4 relative z-10">🤝</div>
                <h3 className="text-xl font-bold text-brand-900 mb-4">Verified Contact Intel</h3>
                <p className="text-sm text-gray-500 leading-relaxed mb-5 relative z-10">
                ...
                <ul className="space-y-2 relative z-10">
                  <li className="flex gap-2 items-start text-[13px] text-gray-700"><span className="text-rose-500 font-bold">→</span> Up to 5 team members on Agency plan</li>
                  <li className="flex gap-2 items-start text-[13px] text-gray-700"><span className="text-rose-500 font-bold">→</span> Shared employer pipeline with status tags</li>
                  <li className="flex gap-2 items-start text-[13px] text-gray-700"><span className="text-rose-500 font-bold">→</span> Admin controls for team access management</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <section className="py-24 px-6 bg-white">
          <div className="max-w-4xl mx-auto">
            <div className="text-center max-w-2xl mx-auto mb-16">
              <div className="text-xs font-bold text-brand-600 uppercase tracking-widest mb-3">Plan Comparison</div>
              <h2 className="text-3xl md:text-4xl font-black text-brand-900 tracking-tight mb-4">
            ...
            <div className="border border-gray-200 rounded-2xl overflow-hidden shadow-sm">
              <div className="grid grid-cols-12 bg-brand-900 p-5">
              ...
              {[
                ...
                { feat: 'Saved searches & alerts', pro: 'Unlimited', ag: 'Unlimited + Shared', proColor: 'text-brand-600 font-medium', agColor: 'text-brand-600 font-bold' },
                { feat: 'Team seats', pro: 'cross', proLabel: '1 user', ag: 'Up to 5 users', agColor: 'text-brand-600 font-bold' },
                { feat: 'Bulk export (CSV/XLS)', pro: 'cross', ag: '500 records/export', agColor: 'text-brand-600 font-bold' },
                ...
                { feat: 'Dedicated onboarding session', pro: 'cross', ag: '60 min session', agColor: 'text-brand-600 font-bold' },
              ].map((row, i) => (
                <div key={i} className="grid grid-cols-12 p-4 border-t border-gray-100 hover:bg-gray-50 items-center transition-colors">
                  ...
                  <div className="col-span-3 text-center text-sm">
                    {row.pro === 'check' ? <Check className="w-5 h-5 text-emerald-700 mx-auto" /> :
                  ...
                  <div className="col-span-3 text-center text-sm">
                    {row.ag === 'check' ? <Check className="w-5 h-5 text-emerald-700 mx-auto" /> :
        ...
        <section className="bg-brand-900 py-24 px-6">
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="text-xs font-bold text-brand-600 uppercase tracking-widest mb-3">Employer Pipeline</div>
              ...
              <ul className="space-y-3">
                <li className="flex gap-3 text-sm text-blue-200/80"><span className="text-brand-600 font-bold">→</span> Tag employers as Prospect, Contacted, Negotiating, or Client</li>
                <li className="flex gap-3 text-sm text-blue-200/80"><span className="text-brand-600 font-bold">→</span> Share pipeline status across all 5 team seats in real time</li>
                <li className="flex gap-3 text-sm text-blue-200/80"><span className="text-brand-600 font-bold">→</span> Save up to 2,000 employer profiles</li>
                <li className="flex gap-3 text-sm text-blue-200/80"><span className="text-brand-600 font-bold">→</span> Export your full pipeline to CSV for CRM import</li>
              </ul>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 shadow-2xl">
              <div className="flex gap-2 mb-4 border-b border-white/10 pb-3">
                <div className="flex-1 text-center text-[10px] font-bold tracking-widest text-brand-400 uppercase">Prospects</div>
                <div className="flex-1 text-center text-[10px] font-bold tracking-widest text-brand-600 uppercase">Contacted</div>
                <div className="flex-1 text-center text-[10px] font-bold tracking-widest text-emerald-500 uppercase">Clients</div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <div className="space-y-2">
                  <div className="bg-white/10 border border-white/10 rounded-lg p-2.5 text-xs text-white">
                    ABC Trucking Ltd
                    <span className="block text-brand-300 text-[10px] mt-1">Alberta · 12 LMIAs</span>
                  </div>
                  <div className="bg-white/10 border border-white/10 rounded-lg p-2.5 text-xs text-white">
                    Northern Health
                    <span className="block text-brand-300 text-[10px] mt-1">BC · 8 LMIAs</span>
                  </div>
                  <div className="bg-white/10 border border-white/10 rounded-lg p-2.5 text-xs text-white">
                    Prairie Farms Inc
                    <span className="block text-brand-300 text-[10px] mt-1">SK · 5 LMIAs</span>
                  </div>
                </div>

                {/* Column 2 */}
                <div className="space-y-2">
                  <div className="bg-brand-100 border border-brand-50/500 rounded-lg p-2.5 text-xs text-white shadow-sm shadow-brand-50">
                    Metro Hotel Group
                ...
                {/* Column 3 */}
                <div className="space-y-2">
                  <div className="bg-emerald-100 border border-emerald-500/40 rounded-lg p-2.5 text-xs text-white shadow-sm shadow-emerald-50">
                    SK Health Board
                    <span className="block text-emerald-50 text-[10px] mt-1">SK · Active client ✓</span>
                  </div>
                  <div className="bg-emerald-100 border border-emerald-500/40 rounded-lg p-2.5 text-xs text-white shadow-sm shadow-emerald-50">
                    Toronto Care Inc
                    <span className="block text-emerald-50 text-[10px] mt-1">ON · 3 placements</span>
                  </div>
                </div>
              </div>
            </div>
