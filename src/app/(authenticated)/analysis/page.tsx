...
import { Building2, BarChart3, TrendingUp, ArrowRight, Search } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <Card className="group hover:shadow-2xl hover:shadow-brand-500/10 transition-all duration-500 border-0 bg-white/80 backdrop-blur-sm">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-xl font-bold text-gray-900">Company Insights</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <p className="text-gray-600 leading-relaxed">
                  Comprehensive analysis of hiring patterns and job distributions
                  by company with detailed metrics and trends.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-2xl hover:shadow-brand-500/10 transition-all duration-500 border-0 bg-white/80 backdrop-blur-sm">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-xl font-bold text-gray-900">Growth Trends</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <p className="text-gray-600 leading-relaxed">
                  Track hiring growth rates and seasonal patterns across different
                  time periods with interactive visualizations.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-2xl hover:shadow-brand-500/10 transition-all duration-500 border-0 bg-white/80 backdrop-blur-sm">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-xl font-bold text-gray-900">Interactive Charts</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <p className="text-gray-600 leading-relaxed">
                  Visual dashboards with location breakdowns, job categories, and
                  NOC code analysis for comprehensive insights.
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <Card className="bg-gradient-to-br from-brand-50 via-white to-brand-50/30 border-brand-200/50 backdrop-blur-sm">
            <CardContent className="text-center py-12">
              ...
              <p className="text-gray-600 max-w-md mx-auto">
                Click the "See All Jobs" button from any job listing in your search results
                to view detailed company analysis and insights.
              </p>
              <Button 
