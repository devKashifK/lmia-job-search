      ...
      <div className="relative z-10 max-w-7xl w-full mx-auto px-4">
        <div className="bg-white/90 rounded-3xl shadow-2xl flex flex-col md:flex-row items-center justify-between p-10 md:p-20 gap-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-10 text-brand-600">
              Advanced search, dynamic insights, and seamless monetization—all
              in one platform.
            </p>
            <div className="flex flex-col sm:flex-row gap-6">
              <CustomLink href="/search">
                <button className="bg-brand-600 text-white px-8 py-4 rounded-full font-semibold hover:bg-brand-700 transition-all duration-300 hover:scale-105 shadow-lg">
                  Get Started
                </button>
              </CustomLink>
        ...
        >
          <div className="bg-brand-100/60 rounded-xl p-8 text-brand-700 text-center shadow hover:bg-brand-200/60 transition-all duration-300">
            <h3 className="text-4xl font-bold mb-3">10K+</h3>
            <p className="text-brand-600">Active Users</p>
          </div>
          <div className="bg-brand-100/60 rounded-xl p-8 text-brand-700 text-center shadow hover:bg-brand-200/60 transition-all duration-300">
            <h3 className="text-4xl font-bold mb-3">1M+</h3>
            <p className="text-brand-600">Searches Performed</p>
          </div>
          <div className="bg-brand-100/60 rounded-xl p-8 text-brand-700 text-center shadow hover:bg-brand-200/60 transition-all duration-300">
            <h3 className="text-4xl font-bold mb-3">99%</h3>
            <p className="text-brand-600">Customer Satisfaction</p>
          </div>
        </motion.div> */}
      </div>
    </section>
